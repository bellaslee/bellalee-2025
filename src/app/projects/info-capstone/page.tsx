    ...
    <main className={styles['project']}>
      ...
      <Container>
        <section className="project-info">
          <h2 className="title md:w-3/4">Gender in STEM: the Power of Image</h2>
          <div className="flex flex-col md:flex-row justify-between md:w-3/4">
            <div>
              <p className="text-xl">Client</p>
              <p>Flickr Foundation</p>
            </div>
            <div>
              <p className="text-xl">Type</p>
              <p>UX Design, UX Research, Marketing Strategy</p>
            </div>
            <div>
          ...
          <Image
            src="/img/posts/info-capstone/bus-mockup.jpg"
            alt="Bus ad mockup."
            width={1891}
            height={1261}
          />
        ...
        <section className="flex flex-col md:flex-row">
          ...
          <div className="flex-1">
            <p>
              ...
              male figures when asked to depict STEM professionals. These
              findings demonstrate a market for a curated social justice gallery
            ...
            <p>
              ...
              representations in STEM. By creating dynamic public and social
              media adverts with images from the study, we encourag
              professionals to engage with the gallery on their daily commute.
              This approach not only directs individuals to a visual resource
              promoting gender diversity, but also normalizes diverse
              representations in STEM, fostering a sense of belonging and
              inspiration.
            </p>
            <p>
              The combination of our research methods, gallery, and its
              marketing strategy demonstrates a commitment to creating a more
              inclusive and equitable STEM community, uplifting individuals who
              have been historically marginalized in these fields.
            </p>
            <p>
              <a
        ...
        <section className="flex flex-col md:flex-row">
          <div className="flex-1 pr-6">
            <h3 className="big">Problem Statement</h3>
          </div>
          <div className="flex-1">
            <p>
              ...
              need for initiatives that drive awareness, empathy, and
              inclusivity.
            </p>
            <p>
        ...
        <section className="flex flex-col md:flex-row">
          <div className="flex-1 pr-6">
            <h3 className="big">Key Research Insights</h3>
          </div>
          <div className="flex-1">
            <h4>Background</h4>
            <p>
              Computing was once considered a feminine endeavor due to its
              routine and mechanical nature (Ensmenger, 2015). The progression
              of STEM spaces has been much like the previous industrial
              revolution, where machinery was developed through the lens of
              “modern manliness” (Oldenziel, 1999, p.19). Men began to push
              women out of the picture and self identifying with pop culture
              images of the genius programmer, effectively colonizing the
              technology space.
            </p>
            <p>
              ...
              people to navigate. “Tech” is glorified as “masculine” through
              image (Ensmenger 2015). Social media trends perpetuate these
              stereotypes, undermining the self-esteem of those who do not fit
              the image of a technologist (Rutledge, 2023).
            </p>
            <p>
            ...
            <p>
              <em>Data analysis:</em> Using the Flickr API, we generated a
              random photo sample of 300 images with tags like engineer,
              hackathon, computer science, and so on. We then hand-coded the
              gender of individuals present in the images and discovered that
              only 38% of identifiable individuals were femme-presenting.
            </p>
            <p>
              <em>Graphic elicitation:</em> We asked 8 study participants to
              draw and use AI image generation to create images of 5 STEM
              professions. Of all the images, only 29% were femme-presenting.
            </p>
            <p>
            ...
            <ol>
              ...
              <li>
                People tended to respect male leadership and authority more,
                while women were not taken as seriously.
              </li>
              <li>
                Participants said representation would make them feel more
                confident in the space due to knowing there were people like
                them who also made it — it's inspirational to see that people
                who do not fit into the stereotype can also succeed.
              </li>
            </ol>
          </div>
        </section>
        <section className="flex flex-col md:flex-row">
          <div className="flex-1">
            <h3 className="big">References</h3>
          </div>
          <div className="flex-1">
            <ul>
              <li>
              ...
              <li>
                National Center for Women & Information Technology. (2023).
